# Retrieving the list of current type codes from the reference googlesheet and splitting it in two n2khabutils data sources
...
```{r}
types_path <- "../../n2khabutils/inst/textdata/types"
```
