# Retrieving the list of environmental pressures from a googlesheet and moving data to two n2khabutils data sources
...
```{r}
ep_path <- "../../n2khabutils/inst/textdata/env_pressures"
```
